...
- Compatibility matrix: published at `docs/reference/apishim-compatibility-matrix.md`; `release.yml` uploads the matrix together with the OpenAPI artifacts and wheel/image artifacts for tag builds.
