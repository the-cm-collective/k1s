...
- Works with kubectl/helm for Deployments/StatefulSets/DaemonSets/Jobs/CronJobs/Ingress/Services/HPA/RBAC; see `docs/apishim-compatibility-matrix.md` for coverage.
