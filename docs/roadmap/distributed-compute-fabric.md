...
| D3 | D2, F1, F2, H5b2-upgrades | Multi-cell service requires explicit locality and cross-cell cost awareness plus repeatable HA recovery and upgrade patterns. |
| D4 | D3, F3, H5b2-upgrades | Domain-scale partner operation needs explainable decisions, stable evidence, and operator-readable HA recovery posture. |
