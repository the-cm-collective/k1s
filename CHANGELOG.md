...
### Changed
- Published k1s runtime package metadata as 0.1.7 for WorkerBee v0.1.7
  wheelhouse alignment.

### Fixed
- Escaped the PDB percentage example in CLI help text so argparse renders
  `50%` correctly.
