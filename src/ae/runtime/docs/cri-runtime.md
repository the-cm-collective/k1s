...
- Internal dependencies: `.base`, `.registry`, `ae.apishim.store`, `ae.controller.spec`, `ae.runtime.cri.api.runtime.v1`, `ae.runtime.ports`, `ae.storage`, `ae.storage.netfs`, `ae.storage.state`
...
## Maintenance Notes
- Line 1218: `# Fallback: allow simple secrets with username/password/registry keys`
